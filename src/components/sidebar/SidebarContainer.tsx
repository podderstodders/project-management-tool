...
export const SidebarContainer = () => {
    ...
    return (
        <aside className="app-sidebar"  style={{width: state.sidebarToggle ? '17.5rem' : '1.2rem', transition: state.sidebarToggle ? 'width 0.5s ease' : 'width 0.3s ease-out', cursor: !state.sidebarToggle ? 'pointer' : '', backgroundColor: state.colors.asideColor}} onClick={!state.sidebarToggle ? () => dispatch({type: 'TOGGLE_SIDEBAR', payload: true}) : undefined}>
            ...
            {
                state.sidebarToggle 
                ?<svg width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none"><path stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 4h3a2 2 0 0 1 2 2v1m-5 13h3a2 2 0 0 0 2-2v-1M4.425 19.428l6 1.8A2 2 0 0 0 13 19.312V4.688a2 2 0 0 0-2.575-1.916l-6 1.8A2 2 0 0 0 3 6.488v11.024a2 2 0 0 0 1.425 1.916zM9.001 12H9m7 0h5m0 0-2-2m2 2-2 2"/></svg>
